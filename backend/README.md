...
### Создание администратора с OTP авторизацией

```bash
# Создать администратора с доступом к admin панели
python manage.py create_admin_user +77001234567

# Или через Docker
docker-compose exec backend python manage.py create_admin_user +77001234567
```

**Важно:** Admin панель использует OTP авторизацию через WhatsApp, как и фронтенд. Подробнее см. [docs/ADMIN_OTP_AUTH.md](../docs/ADMIN_OTP_AUTH.md)
...
Django Admin доступен по адресу http://localhost:8001/admin/

**Авторизация через OTP:**
1. Введите номер телефона
2. Получите код в WhatsApp
3. Введите код и войдите
...
Подробная документация: [docs/ADMIN_OTP_AUTH.md](../docs/ADMIN_OTP_AUTH.md)
